...
export default function PublicProfileView({ username }: { username: string }) {
  ...
  if (errorText || !profile) {
    return (
      <main data-testid="profile-root-error" className="min-h-screen max-w-md md:max-w-3xl lg:max-w-5xl mx-auto p-4 pb-24">
  ...
  return (
    <main data-testid="profile-root" className="min-h-screen max-w-md md:max-w-3xl lg:max-w-5xl mx-auto p-4 pb-24">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div data-testid="profile-handle" className="text-xs opacity-70">@{shownHandle}</div>
          </div>
        </div>
